...
import { PROPERTYRENT, AVAILABLE } from "../constant/constants";
...
class RentProperty extends Component {
    ...
    render() {
        return (<div>
            <Card className={this.props.rentPropertyModal + " modal"}>
                <div className="modal-content col-5">
                    <div className="d-flex justify-content-between">
                        <div>
                            {this.props.isEdit ? <h4>Update Property</h4> : <h4>Add Rent Property</h4>}
                        </div>
                        <div
                            className="close"
                            onClick={() => {
                                this.setState({ data: { propertyType: PROPERTYRENT, propertyStatus: AVAILABLE } });
                                document.getElementById("new-form").reset();
                                this.props.closeRentPropertyHandle();
                            }}
                        >
                            &times;
                        </div>
                    ...
                    <Container>
                        <form id="new-form">
                            <div className="form-group">
                                ...
                                />
                                <label style={{ fontWeight: "bold" }}>Lease Term</label>
                                <input
                                    name="leaseTerm"
                                    onChange={e => {
                                        var data = { ...this.state.data };
                                        data.leaseTerm = e.target.value
                                        this.setState({ data })
                                    }}
                                    type="text"
                                    placeholder="Lease Term"
                                    className="form-control"
                                    value={this.state.data.leaseTerm}
                                />
                                <label style={{ fontWeight: "bold" }}>Lease Start Date</label>
                                <input
                                    name="leaseStartDate"
                                    onChange={e => {
                                        var data = { ...this.state.data };
                                        data.leaseStartDate = e.target.value
                                        this.setState({ data })
                                    }}
                                    type="date"
                                    className="form-control"
                                    value={this.state.data.leaseStartDate}
                                />
                                <label style={{ fontWeight: "bold" }}>Lease End Date</label>
                                <input
                                    name="leaseEndDate"
                                    onChange={e => {
                                        var data = { ...this.state.data };
                                        data.leaseEndDate = e.target.value
                                        this.setState({ data })
                                    }}
                                    type="date"
                                    className="form-control"
                                    value={this.state.data.leaseEndDate}
                                />
                                <label style={{ fontWeight: "bold" }}>Security Deposit</label>
                                <input
                                    name="securityDeposit"
                                    onChange={e => {
                                        var data = { ...this.state.data };
                                        data.securityDeposit = e.target.value
                                        this.setState({ data })
                                    }}
                                    type="number"
